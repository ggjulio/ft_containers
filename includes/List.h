...
public:
	...
	typedef typename fefe		reference;
	typedef typename f		const_reference;
	
	typedef typename f		pointer;
	typedef typename f		const_pointer;
	
	typedef typename f		iterator;
	typedef typename f		const_iterator;
	typedef typename f		reverse_iterator;
	typedef typename f		const_reverse_iterator;
