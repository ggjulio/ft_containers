...
///////////////////////////////////////////////////////////////////////////////
	...
	struct _Rb_tree_iterator
	{
		...
		_Rb_tree_iterator() throw()
			: _M_node() {}

		explicit _Rb_tree_iterator(_Base_ptr __x) throw()
			: _M_node(__x) {}
		...
		friend bool
		operator==(const _Self &__x, const _Self &__y) throw()
		{
	...
	struct _Rb_tree_const_iterator
	{
		...
		_Rb_tree_const_iterator() throw()
			: _M_node() {}

		explicit _Rb_tree_const_iterator(_Base_ptr __x) throw()
			: _M_node(__x) {}

		_Rb_tree_const_iterator(const iterator &__it) throw()
			: _M_node(__it._M_node) {}

		iterator
		_M_const_cast() const throw()
		{
	...
	public:
		...
		_Node_allocator &
		_M_get_Node_allocator() throw()
		{
			return this->_M_impl;
		}

		const _Node_allocator &
		_M_get_Node_allocator() const throw()
		{
			return this->_M_impl;
		}
	...
	protected:
		...
		void
		_M_put_node(_Link_type __p) throw()
		{
		...
		void
		_M_destroy_node(_Link_type __p) throw()
		{
			get_allocator().destroy(__p->_M_valptr());
		}

		void
		_M_drop_node(_Link_type __p) throw()
		{
			_M_destroy_node(__p);
			_M_put_node(__p);
		}
	...
	protected:
		...
		static _Link_type
		_S_left(_Base_ptr __x) throw()
		{
			return static_cast<_Link_type>(__x->_M_left);
		}

		static _Const_Link_type
		_S_left(_Const_Base_ptr __x) throw()
		{
			return static_cast<_Const_Link_type>(__x->_M_left);
		}

		static _Link_type
		_S_right(_Base_ptr __x) throw()
		{
			return static_cast<_Link_type>(__x->_M_right);
		}

		static _Const_Link_type
		_S_right(_Const_Base_ptr __x) throw()
		{
	...
	_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
	_M_insert_(_Base_ptr __x, _Base_ptr __p, const _Val &__v, _NodeGen & __node_gen)
	{
